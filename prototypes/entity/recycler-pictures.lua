...
local function recycler_direction(key)
  return
  {
    layers =
    {
      util.sprite_load("__quality-se__/graphics/entity/recycler/recycler-"..key,
      {
        priority = "high",
        frame_count = 64,
      ...
      util.sprite_load("__quality-se__/graphics/entity/recycler/recycler-"..key.."-shadow",
      {
        draw_as_shadow = true,
        priority = "high",
        frame_count = 64,
...
local function recycler_direction_frozen(key)
  return util.sprite_load("__quality-se__/graphics/entity/recycler/recycler-"..key.."-frozen",
  {
    priority = "high",
    scale = 0.5
  })
...
local function recycler_lights(key)
  return util.sprite_load("__quality-se__/graphics/entity/recycler/recycler-"..key.."-lights",
  {
    draw_as_glow = true,
    priority = "high",
    frame_count = 64,
...
local function recycler_smoke()
  return {
    ...
    animation =
    {
      filename = "__quality-se__/graphics/entity/recycler/recycler-smoke-outer.png",
      frame_count = 47,
      line_length = 16,
      width = 90,
      height = 188,
  ...
  },
  {
    ...
    animation =
    {
      filename = "__quality-se__/graphics/entity/recycler/recycler-smoke-inner.png",
      frame_count = 47,
      line_length = 16,
      width = 40,
      height = 84,

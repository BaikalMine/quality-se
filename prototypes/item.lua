...
({
  {
    ...
    icon = "__quality-se__/graphics/icons/quality-module.png",
    subgroup = "module",
    color_hint = { text = "Q" },
    category = "quality",
    tier = 1,
  ...
  },
  {
    ...
    localised_description = { "item-description.quality-module" },
    icon = "__quality-se__/graphics/icons/quality-module-2.png",
    subgroup = "module",
    color_hint = { text = "Q" },
    category = "quality",
    tier = 2,
  ...
  },
  {
    ...
    localised_description = { "item-description.quality-module" },
    icon = "__quality-se__/graphics/icons/quality-module-3.png",
    subgroup = "module",
    color_hint = { text = "Q" },
    category = "quality",
    tier = 3,
